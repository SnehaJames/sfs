...
$config['smsapi'] = getenv('smsapi') ? getenv('smsapi') : "http://localhost/smsapi/api/";
$config['smsbot'] =  getenv('smsbot') ? getenv('smsbot') : "http://sfsbot.azurewebsites.net/api/";
$config['boturl'] = getenv('boturl') ? getenv('boturl') : "https://www.messenger.com/t/474224362923430";
