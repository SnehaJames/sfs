    ...
    <ul id="main-menu" class="">
                                ...
                                $page_name == 'student_bulk_add' ||
                                    $page_name == 'student_information' ||
                                        $page_name == 'student_marksheet' ||
                                            $page_name == 'student_promotion' || $page_name == 'student_bulk_import')
        ...
        ?> ">
            ...
            <ul>
                ...
                <!-- STUDENT BULK IMPORT -->
                <li class="<?php if ($page_name == 'student_bulk_import') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/student_bulk_import">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('student_bulk_import'); ?></span>
                    </a>
                </li>
        ...
        <!-- Bot Profile -->
        <li class="<?php
        if ($page_name == 'bot_profile' || $page_name == 'bot_responses' || $page_name == 'send_message')
            echo 'opened active';
        ?> ">
            <a href="#">
                <i class="entypo-lifebuoy"></i>
                <span><?php echo get_phrase('bot_profile'); ?></span>
            </a>
            <ul>
                <li class="<?php if ($page_name == 'bot_profile') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/bot_profile">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('general_settings'); ?></span>
                    </a>
                </li>
                <li class="<?php if ($page_name == 'bot_management') echo 'active'; ?> ">
                    <a href="#">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('bot_management'); ?></span>
                    </a>
                    <ul>
                        <?php
                        $classes = $this->db->get('bot_response_types')->result_array();
                        foreach ($classes as $row):
                            ?>
                            <li class="<?php if ($page_name == 'bot_management' && $type_id == $row['id']) echo 'active'; ?>">
                                <a href="<?php echo base_url(); ?>index.php?admin/bot_management/<?php echo $row['id']; ?>">
                                    <span><?php echo get_phrase($row['type']); ?></span>
                                </a>
                            </li>
                        <?php endforeach; ?>
                    </ul>
                ...
                <!-- SEND MESSAGE -->
                <li class="<?php if ($page_name == 'send_message') echo 'opened active'; ?> ">
                    <a href="#">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('send_message'); ?></span>
                    </a>
                    <ul>
                        <?php
                        $classes = $this->db->get('class')->result_array();
                        foreach ($classes as $row):
                            ?>
                            <li class="<?php if ($page_name == 'send_message' && $class_id == $row['class_id']) echo 'active'; ?>">
                                <a href="<?php echo base_url(); ?>index.php?admin/send_message/<?php echo $row['class_id']; ?>">
                                    <span><?php echo get_phrase('class'); ?> <?php echo $row['name']; ?></span>
                                </a>
                            </li>
                        <?php endforeach; ?>
