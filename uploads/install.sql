...
--
-- Host: localhost
-- Generation Time: Oct 05, 2016 at 01:17 PM
...
CREATE TABLE IF NOT EXISTS `book_request` (
  ...
  `book_id` int(11) NOT NULL,
  `student_id` int(11) NOT NULL,
  `issue_start_date` longtext COLLATE utf8_unicode_ci NOT NULL,
  `issue_end_date` longtext COLLATE utf8_unicode_ci NOT NULL,
...
(1, 'Mr. Alen', 'librarian@example.com', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220');
...
CREATE TABLE IF NOT EXISTS `question_paper` (
  ...
  `title` longtext COLLATE utf8_unicode_ci NOT NULL,
  `question_paper` longtext COLLATE utf8_unicode_ci NOT NULL,
  `class_id` int(11) NOT NULL,
  `exam_id` int(11) NOT NULL,
  `teacher_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
DROP TABLE IF EXISTS `student_bulk_import`;
CREATE TABLE `student_bulk_import` (
...
--
ALTER TABLE `language`
  MODIFY `phrase_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=410;
--
...
DROP TABLE IF EXISTS `bot_profile`;
CREATE TABLE `bot_profile` (
  `bot_profile_id` int(11) NOT NULL AUTO_INCREMENT,
  `type` varchar(255) NOT NULL,
  `description` text,
  PRIMARY KEY (`bot_profile_id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=latin1;

DROP TABLE IF EXISTS `bot_response_types`;
CREATE TABLE `bot_response_types` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `type` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `bot_responses` (
  `bot_response_id` int(11) NOT NULL AUTO_INCREMENT,
  `type` varchar(255) NOT NULL,
